...
import co.edu.uniajc.services.wse_estado.service.EstadoService;
...
public class EstadoController {
	...
	@Autowired
	private EstadoService productosService;
	
	@CrossOrigin(origins = "*", methods= {RequestMethod.POST})
	@PostMapping(path="/guardar")
	public Estado insertEstado(@RequestBody Estado producto) {
		return productosService.saveProducto(producto);
	}
	
	@CrossOrigin(origins = "*", methods= {RequestMethod.PUT})
	@PutMapping(path = "/modificar")
	public Estado updateEstado(@RequestBody Estado producto) {
